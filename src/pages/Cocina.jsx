...
export default function Cocina() {
  ...
  return (
    <div>
      ...
      {phase === 'game' && (
        <GameBoard categories={categories} usedQuestions={usedQuestions} teams={teams} currentTeamIndex={currentTeamIndex} onSelectQuestion={selectQuestion} onReset={resetGame} />
      )}
